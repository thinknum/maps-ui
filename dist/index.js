...
var MediaMapTheme = (_b = {},
    _b[exports.MapStyle.DARK] = "mapbox://styles/ugwigr/cka7zrmh40j7j1inr3bxl4lrn",
    _b[exports.MapStyle.LIGHT] = "mapbox://styles/ugwigr/cka7zt0cz0j8o1inr6eukbyfi",
    _b);
...
var stylesByButton = (_a$1 = {},
    _a$1[exports.ButtonType.ZOOM_IN] = zoomIn,
    _a$1[exports.ButtonType.ZOOM_OUT] = zoomOut,
    _a$1);
var icons = (_b$1 = {},
    _b$1[exports.ButtonType.ZOOM_IN] = ZoomIn,
    _b$1[exports.ButtonType.ZOOM_OUT] = ZoomOut,
    _b$1);
...
var MapCore = /** @class */ (function (_super) {
    ...
    MapCore.prototype.componentDidUpdate = function (prevProps) {
        var _a = this.props, fitBounds = _a.fitBounds, initialViewport = _a.initialViewport, width = _a.width, height = _a.height;
    ...
    MapCore.prototype.applyFitBounds = function () {
        var _a = this.props, fitBounds = _a.fitBounds, width = _a.width, height = _a.height, viewport = _a.viewport, disableTransitions = _a.disableTransitions;
        ...
        var transitionProps = disableTransitions ? {} : {
            transitionInterpolator: new ReactMapGL.FlyToInterpolator(),
    ...
    MapCore.prototype.applyInitialViewport = function () {
        var _a = this.props, initialViewport = _a.initialViewport, viewport = _a.viewport;
        if (!initialViewport) {
            return;
        }
        this.props.onViewportChange(__assign({}, viewport, initialViewport));
    };
    ...
    function MapContainer$1() {
        ...
        _this.handleZoomOutOnClick = function () {
            ...
            if (_this.props.viewport && _this.props.onViewportChange) {
                _this.props.onViewportChange(updatedViewport, true);
            }
            else {
                _this.setState({
...
exports.MediaMapTheme = MediaMapTheme;
exports.ThinknumMapTheme = ThinknumMapTheme;
