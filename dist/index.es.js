...
var MapCore = /** @class */ (function (_super) {
    ...
    MapCore.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(ReactMapGL, __assign({ mapboxApiAccessToken: "pk.eyJ1IjoidWd3aWdyIiwiYSI6Ik8tRERDbEkifQ.HXbQmU5i9bYU7c5HHVVxyA", mapStyle: mapStyle, preserveDrawingBuffer: isEmbedded ? false : true }, viewport, { ref: this.reactMapRef, width: width, height: height, doubleClickZoom: isDoubleClickDisabled ? false : true, onViewportChange: function (info) {
                    onPointHover(undefined);
                    onOverlayHover(undefined);
                    onClick(undefined);
                ...
                React.createElement(DeckGL, { viewState: viewport, ref: this.handleUpdateDeckRef, width: width, height: height, layers: layers, onHover: this.onLayerHover, onClick: this.onLayerClick, pickingRadius: 5, glOptions: isEmbedded ? undefined : { preserveDrawingBuffer: true } }),
                children,
